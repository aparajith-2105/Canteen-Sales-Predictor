...
- ⚠️ Warns you when tomorrow's inputs fall outside the range of your data
...
| Option | What it does |
|---|---|
| 1️⃣ | Add one day of data by typing it in |
| 2️⃣ | Load 200 fake demo days (for testing) |
| 3️⃣ | Train the model and see what it learned |
| 4️⃣ | Predict tomorrow |
| 5️⃣ | Show all saved data |
| 6️⃣ | Quit |
...
- 🍽️ Linear regression suits large daily totals (roughly 200+ plates). For small per-item counts, a Poisson regression version is a better fit.
